...
public class LancamentoRepositoryImpl implements LancamentoRespositoryQuery {
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<?> query, Pageable pageable) {
		...
		int primeiroRegistroDaPagina = paginaAtual * totalRegistrosPorPaginas; //numero de lancamentos a multiplicar por num de pagina
...
CriteriaBuilder criteriaBuilder = manager.getCriteriaBuilder();
		...
		criteriaQuery.select(criteriaBuilder.construct(LancamentoEstatisticaCategoria.class, 
		     ...
		     // faz somatorio dos valores de todos os lancamentos por determinado categoria 
		...
		criteriaQuery.where(
				...
				criteriaBuilder.lessThanOrEqualTo(root.get(Lancamento_.dataVencimento), 
						ultimoDia));
		// Sera listado somente lancamentos por categoria no corrente mes do dia 01 ate ao fin
		// baseando em campo dataVencimento
